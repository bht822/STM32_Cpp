...
namespace mcal {
	...
	namespace reg {
							...
							const std::uint32_t adc1_base     = periph_base + 0x12000U;
							...
							// Timer 2 regsisters
							const std::uint32_t tim2_cr1     = tim2_base + timer_cr1_offset;
							const std::uint32_t tim2_cr2     = tim2_base + timer_cr2_offset;
